...
A WhatsApp bot built with Node.js and `whatsapp-web.js` to provide real-time cryptocurrency information, price tracking alerts, currency conversion, and group management utilities.
...
1.  **Clone the repository:**
    ...
    cd bot-wa-crypto
    ```
    *(Adjust `cd bot-wa-crypto` if your folder name is different)*
...
*(Most commands should be sent in the WhatsApp group chat where the bot is present)*
